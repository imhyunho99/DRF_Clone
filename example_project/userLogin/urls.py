...
from .views import RegisterView, LoginView, LogoutView, UserDetailView, DeleteUserView, TokenRegisterView, TokenLoginView, TokenLogoutView, TokenUserDetailView, TokenDeleteUserView
